 ...
 *   Step 2  gapAnalysis       — compare the latest (authoritative) original spec vs the reverse spec, surface behavioural gaps.
 *   Step 3  questionGeneration — turn each gap into exactly one specific, answerable question for the Respondent.
 *
